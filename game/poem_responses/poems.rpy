...
init 1 python:
    ...
    author_l = Author("lily", music=audio.lily, paper="images/bg/poem_l.jpg")
    ...
    poem_l1 = Poem(
        author_l, title=_("UFO"),
        text=_("""\
I saw something strange
Something I've never seen before
A little UFO painted in gold and silver
Which I chose not to ignore

It took me on a journey, through the hills and trees
And when I got home, to tell my friends at school
Instead of going "wow!" and "That's so cool!"
They all just laughed! They love to tease

They'd call me funny names like "Alien" and "Weirdo"
The people I see tell me I'm not, though
Someday I hope my friends can see that little UFO
And finally know 
    how to be happy"""))
    poem_y1 = Poem(
