...
define config.name = "What You Mean to Me"
...
define gui.about = _("We're a joke studio turned serious, Team Half Joking began as\na group of misfits writing stories, who knew that this story would make the cut for our debut?")
