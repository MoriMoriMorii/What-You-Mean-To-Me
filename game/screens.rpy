...
define -2 text_outline_color = "#8643a5"
...
style poemgame_text:
    ...
    hover_xoffset -3
    hover_outlines [(3, "#eeffef", 0, 0), (2, "#ccffdc", 0, 0), (1, "#aaffc6", 0, 0)]
        ...
        for i in items:
            ...
            if "kwargs=" in i.caption:
                ...
                if "#" in kwarg:
                    ...
                    textbutton caption:
                        idle_background Frame(im.MatrixColor(im.MatrixColor("gui/button/choice_idle_background.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#394e35", "#aaffc6") * im.matrix.saturation(120)), 
                            im.matrix.desaturate() * im.matrix.colorize(arg1, arg2)), gui.choice_button_borders)
                        hover_background Frame(im.MatrixColor(im.MatrixColor("gui/button/choice_hover_background.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#394e35", "#aaffc6") * im.matrix.saturation(120)), 
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                ...
                text "Made with Bronya Rand's {a=https://github.com/GanstaKingofSA/DDLCModTemplate2.0}DDLC Mod Template 2.0{/a}.\nCopyright © 2019-Present Azariel Del Carmen (Bronya Rand). All rights reserved.\n"
                text "PS:If you're reading this, <3\n"
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        add FileScreenshot(slot) xalign 0.5 xoffset 15
