...
define audio.t1 = "bgm/t1.mp3"
define audio.setstage = "bgm/to-set-a-stage.mp3"
define audio.sunshine = "bgm/good-morning-sunshine.mp3"
define audio.late_lonely = "bgm/late-nights-and-lonely-lights.mp3"
define audio.t1o = "<loop 22.073>bgm/1.ogg" # Doki Doki Literature Club! - Main Theme
...
define audio.lily = "<loop 4.444>bgm/5_lily.ogg"
...
image bg school_outside = "bg/school_outside.png"
image bg club_night = "bg/club_night.png" # The club BG
...
image bg bedroom_night = "bg/bedroom_night.png" #MC's Room at night BG
image bg bedroom_dusk = "bg/bedroom_dusk.png" #MC's Room at dusk BG
...
define l = DynamicCharacter('l_name', image='lily', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", window_background=Image("gui/textbox_lily.png", xalign=0.5, yalign=1.0), who_outlines=[  (3, "#9375ab")  ])
define narrator = Character(ctc="ctc", ctc_position="fixed")
define mc = DynamicCharacter('player', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[ (3, "#251234")])
define s = DynamicCharacter('s_name', image='sayori', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", window_background=Image("gui/textbox_sayori.png", xalign=0.5, yalign=1.0), who_outlines=[  (3, "#689cdf")  ])
define m = DynamicCharacter('m_name', image='monika', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", window_background=Image("gui/textbox_monika.png", xalign=0.5, yalign=1.0), who_outlines=[  (3, "#34ad6d")  ])
define n = DynamicCharacter('n_name', image='natsuki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", window_background=Image("gui/textbox_natsuki.png", xalign=0.5, yalign=1.0), who_outlines=[  (3, "#b59")  ])
define y = DynamicCharacter('y_name', image='yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", window_background=Image("gui/textbox_yuri.png", xalign=0.5, yalign=1.0), who_outlines=[  (3, "#7734ad")  ])
...
define persistent.lily = False
default persistent.lily = False
define lily_firstread = False
